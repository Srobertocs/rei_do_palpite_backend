/*
  ...
  - The values [GANHADA] on the enum `CampaignOptionStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "CampaignOptionStatus_new" AS ENUM ('GANHA', 'PERDIDA', 'PENDENTE');
